    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                        <a class="nav-link" href="vendedor_list.php"><i class="bi bi-people"></i> Cadastrar Vendedores</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="vendas_list.php"><i class="bi bi-people"></i> Cadastrar Vendas</a>
                    </li>
				...
				<li class="nav-item">
                        <a class="nav-link" href="relatorio_comissao.php"><i class="bi bi-clipboard2-data"></i> Comissões</a>
                    </li>
                <?php endif; ?>
            </ul>
