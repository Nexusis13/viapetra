...
// Buscar dados da venda com vendedor e comissão
$sql = "SELECT v.*, vd.nome as nome_vendedor, vd.celular, vd.tipochave, vd.chave, 
...
$sqlBoletos = "SELECT b.*, v.nome as nome_vendedor
               FROM boleto b
...
if ($venda['percentual_comissao']) {
    ...
    $valor_comissao_total = ($venda['vlr_total'] * $venda['percentual_comissao']) / 100;
    
    // Comissão sobre a entrada (se houver)
    if ($valor_entrada_real > 0) {
        $valor_comissao_entrada = ($valor_entrada_real * $venda['percentual_comissao']) / 100;
    }
    
    // Comissão sobre o valor parcelado (se houver)
    if ($valor_parcelado > 0) {
        $valor_comissao_parcelado = ($valor_parcelado * $venda['percentual_comissao']) / 100;
    }
}
...
<div class="container">
                ...
                <div class="card-body">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            ...
                            <td><?= htmlspecialchars($venda['celular'] ?? 'N/A') ?></td>
                        </tr>
                        <tr>
                            <td><strong>Tipo de Chave:</strong></td>
                            <td><?= htmlspecialchars($venda['tipochave'] ?? 'N/A') ?></td>
                        </tr>
                        <tr>
                            <td><strong>Chave PIX:</strong></td>
                            <td><?= htmlspecialchars($venda['chave'] ?? 'N/A') ?></td>
                        </tr>
                        <tr>
                            <td><strong>Comissão:</strong></td>
                            <td>
                                <?php if ($venda['percentual_comissao']): ?>
                                    <span class="badge bg-info"><?= $venda['percentual_comissao'] ?>%</span>
                                <?php else: ?>
                                    <span class="text-muted">N/A</span>
                                <?php endif; ?>
                            </td>
                    ...
                    <div class="row">
                        ...
                        <?php if ($venda['qtd_parcelas'] == 0 || $eh_pagamento_integral): ?>
                            ...
                            <div class="col-md-6 text-center">
                                ...
                                <h4 class="text-info">R$ <?= number_format($valor_comissao_total, 2, ',', '.') ?></h4>
                            ...
                            <div class="col-md-3 text-center">
                                ...
                                <?php if ($venda['qtd_parcelas'] == 0): ?>
                                    ...
                                    <small class="text-success">Sem parcelas - Comissão liberada</small>
                                <?php else: ?>
                                    <h5><span class="badge bg-success">Integral</span></h5>
                                    <small class="text-success">Comissão liberada</small>
                                <?php endif; ?>
                            </div>
                        <?php else: ?>
                            ...
                            <div class="col-md-2 text-center">
                                ...
                                <?php if ($valor_comissao_entrada > 0): ?>
                                    <small class="text-muted">Comissão: R$ <?= number_format($valor_comissao_entrada, 2, ',', '.') ?></small>
                                <?php endif; ?>
                            </div>
                            <div class="col-md-2 text-center">
                                <h6>Valor Parcelado</h6>
                                <h4 class="text-warning">R$ <?= number_format($valor_parcelado, 2, ',', '.') ?></h4>
                                <?php if ($valor_comissao_parcelado > 0): ?>
                                    <small class="text-muted">Comissão: R$ <?= number_format($valor_comissao_parcelado, 2, ',', '.') ?></small>
                                <?php endif; ?>
                            </div>
                            <div class="col-md-2 text-center">
                                <h6>Comissão Total</h6>
                            ...
                            <div class="col-md-3 text-center">
                                ...
                                <small class="text-warning">Comissão por vencimento</small>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Detalhamento da Comissão (<?= $venda['percentual_comissao'] ?>%)</h5>
                </div>
                <div class="card-body">
                    <?php if ($venda['qtd_parcelas'] == 0): ?>
                        <div class="alert alert-success">
                            <h6><i class="fas fa-money-bill-wave"></i> Pagamento à Vista</h6>
                            <p class="mb-0">Comissão total de <strong>R$ <?= number_format($valor_comissao_total, 2, ',', '.') ?></strong> 
                            deve ser paga ao vendedor na data da venda: <strong><?= date('d/m/Y', strtotime($venda['dt_venda'])) ?></strong></p>
                    ...
                    <?php else: ?>
                        <div class="alert alert-info">
                            ...
                            <div class="row">
                                <?php if ($valor_entrada_real > 0): ?>
                                <div class="col-md-6">
                                    <strong>Comissão da Entrada:</strong><br>
                                    <span class="text-success">R$ <?= number_format($valor_comissao_entrada, 2, ',', '.') ?></span><br>
                                    <small class="text-muted">Pagar na data da venda: <?= date('d/m/Y', strtotime($venda['dt_venda'])) ?></small>
                                </div>
                                <?php endif; ?>
                                <div class="col-md-6">
                                    <strong>Comissão das Parcelas:</strong><br>
                                    <span class="text-warning">R$ <?= number_format($valor_comissao_parcelado, 2, ',', '.') ?></span><br>
            ...
            <?php if ($venda['qtd_parcelas'] == 0): ?>
                <div class="alert alert-success">
                    ...
                    <ul class="mb-2">
                        ...
                        <?php if ($venda['percentual_comissao']): ?>
                            <li><strong>Comissão:</strong> R$ <?= number_format($valor_comissao_total, 2, ',', '.') ?> (<?= $venda['percentual_comissao'] ?>%)</li>
                        <?php endif; ?>
                    </ul>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php foreach ($boletos as $boleto): ?>
                                <?php
                                // Comissão baseada no valor da parcela
                        ...
                        <tfoot>
                            <tr class="table-secondary">
                                ...
                                <td colspan="3"></td>
                                <td><strong>R$ <?= number_format($valor_comissao_parcelado, 2, ',', '.') ?></strong></td>
                                <td></td>
                            </tr>
                        </tfoot>
                    </table>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul>
                    ...
                    <?php if ($valor_comissao_total > 0): ?>
                        <li>Cancelar comissão de R$ <?= number_format($valor_comissao_total, 2, ',', '.') ?></li>
                    <?php endif; ?>
                </ul>
