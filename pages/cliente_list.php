...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['excluir_cliente'])) {
    ...
    $delete_sql = "DELETE FROM clientes WHERE client_id = ?";
    $stmt_delete = $pdo->prepare($delete_sql);
    if ($stmt_delete->execute([$client_id])) {
        $sucesso_msg = "Cliente excluído com sucesso!";
    } else {
        $erro_msg = "Erro ao excluir cliente.";
    }
}
            ...
            <div class="card">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted">Tente ajustar os filtros ou <a href="cliente_form.php">cadastrar um novo cliente</a></p>
                    </div>
                    <?php else: ?>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= !empty($cliente['dt_nascimento']) ? date('d/m/Y', strtotime($cliente['dt_nascimento'])) : '' ?></td>
...
function exportarDados() {
    ...
    params.set('export', '1');
    window.location.href = 'export_clientes.php?' + params.toString();
}
